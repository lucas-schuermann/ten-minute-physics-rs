...
impl SoftBody {
    pub fn new() -> Self {
        ...
        let mut body = Self {
            ...
            edge_compliance: DEFAULT_EDGE_COMPLIANCE,
            vol_compliance: DEFAULT_VOL_COMPLIANCE,
    ...
    pub fn tet_surface_tri_ids() -> Vec<usize> {
        mesh::get_bunny().tet_surface_tri_ids
    }
